export default class FmsDate {
  constructor(_date) {
    ...
    let dayInWeek;
    switch (date.getDay()) {
      case 0: dayInWeek = "CNhật"; break;
      case 1: dayInWeek = "Thứ 2"; break;
      case 2: dayInWeek = "Thứ 3"; break;
      case 3: dayInWeek = "Thứ 4"; break;
      case 4: dayInWeek = "Thứ 5"; break;
      case 5: dayInWeek = "Thứ 6"; break;
      case 6: dayInWeek = "Thứ 7"; break;
    }
    this.date = day;
    this.month = month;
    this.year = year;
