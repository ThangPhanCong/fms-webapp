...
import {getFailureOrder, getSuccessOrder} from "../../../api/OrderApi";
        ...
        return (
            <div className="row">
                <div className="col-lg-12">
                    <div className="ibox">
                        <FmsFailureOrderSearchBar
                            onSearchQueryChange={this.searchItem.bind(this)}
                        />
