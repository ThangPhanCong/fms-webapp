    ...
    renderNoteList() {
        if (this.state.type === 0) {
            ...
            return <div>
                ...
                <button className="btn button-note-option btn-primary" onClick={this.confirmAddNote.bind(this)}>Thêm</button>
                <button className="btn button-note-option btn-default" onClick={this.cancelAddNote.bind(this)}>Hủy</button>
            </div>
        } else if (this.state.type === 3) {
            return <div>
                <textarea ref="note" className="add-note-content" defaultValue={this.state.selectedNote.content}/>
                <button className="btn button-note-option btn-primary" onClick={this.confirmUpdateNote.bind(this)}>Cập nhật</button>
                <button className="btn button-note-option btn-default" onClick={this.cancelAddNote.bind(this)}>Hủy</button>
            </div>
        }
    }
