...
import {deleteOrder, orderTransportedOrder} from "../../../api/OrderApi";
import {cloneDiff} from "../../../utils/object-utils";
import {getOrderTags} from "../../../api/OrderTagApi";

class FmsExportOrderDetailModal extends Component {
    ...
    orderTransport() {
        ...
        orderTransportedOrder(project.alias, diffOrder)
            .then(order => {
                ...
                <div className='order-detail-modal inmodal'>
                    ...
                    <Modal.Footer>
                        ...
                        <button className="btn btn-primary"
                                onClick={() => this.orderTransport()}
                                disabled={isLoading}>Yêu cầu vận chuyển
                        </button>
                    </Modal.Footer>
...
FmsExportOrderDetailModal.propTypes = {
    isShown: propTypes.bool.isRequired,
    onClose: propTypes.func.isRequired
};

export default FmsExportOrderDetailModal;
