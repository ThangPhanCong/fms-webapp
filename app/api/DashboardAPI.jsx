...
module.exports = {
	getConversations: function (pageid) {
		let route = `/api/pages/${pageid}/conversations`;
		return ApiSender.get(route);
	},
	getMessageInbox: function (inboxid) {
		let route = `/api/inbox/${inboxid}/messages`;
		return ApiSender.get(route);
	},
	getReplyComment: function (commentid) {
		let route = `/api/comment/${commentid}/comments`;
		return ApiSender.get(route);
	}
}
